...
import static com.vansuita.passwordvault.R.menu.store;
...
public abstract class BaseStoreFragment<T extends Bean> extends Fragment implements IBaseStoreFragment<T> {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.findItem(R.id.action_open_widget).setVisible(Util.canShowWidget(getActivity()));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_open_widget:
                FloatingPasswordService.start(getActivity(), object);
